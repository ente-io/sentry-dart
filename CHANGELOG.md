...
- Bump Android SDK from v6.15.0 to v8.15.1 ([#251](https://github.com/ente-io/sentry-dart/pull/251))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8151)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...8.15.1)
