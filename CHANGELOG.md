...
- Bump Android SDK from v6.15.0 to v8.0.0 ([#204](https://github.com/ente-io/sentry-dart/pull/204))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#800)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...8.0.0)
