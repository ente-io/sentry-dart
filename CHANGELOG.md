...
- Bump Android SDK from v6.15.0 to v6.27.0 ([#78](https://github.com/ente-io/sentry-dart/pull/78))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6270)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...6.27.0)
