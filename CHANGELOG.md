...
- Bump Android SDK from v6.15.0 to v6.21.0 ([#61](https://github.com/ente-io/sentry-dart/pull/61))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6210)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...6.21.0)
