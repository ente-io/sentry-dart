...
- Bump Android SDK from v6.15.0 to v8.24.0 ([#279](https://github.com/ente-io/sentry-dart/pull/279))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8240)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...8.24.0)
