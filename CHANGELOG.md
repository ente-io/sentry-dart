...
- Bump Android SDK from v6.15.0 to v8.25.0 ([#281](https://github.com/ente-io/sentry-dart/pull/281))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8250)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...8.25.0)
