...
- Bump Android SDK from v6.4.2 to v6.11.0 ([#25](https://github.com/ente-io/sentry-dart/pull/25))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6110)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.4.2...6.11.0)
