...
- Bump Android SDK from v6.15.0 to v7.1.0 ([#121](https://github.com/ente-io/sentry-dart/pull/121))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#710)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...7.1.0)
