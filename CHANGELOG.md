...
- Bump Android SDK from v6.4.2 to v6.10.0 ([#23](https://github.com/ente-io/sentry-dart/pull/23))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6100)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.4.2...6.10.0)
