...
- Bump Android SDK from v6.15.0 to v8.12.0 ([#233](https://github.com/ente-io/sentry-dart/pull/233))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8120)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...8.12.0)
