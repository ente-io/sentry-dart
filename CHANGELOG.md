...
- Bump Android SDK from v6.15.0 to v8.7.0 ([#221](https://github.com/ente-io/sentry-dart/pull/221))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#870)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...8.7.0)
