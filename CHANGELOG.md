...
- Bump Android SDK from v6.15.0 to v8.43.2 ([#350](https://github.com/ente-io/sentry-dart/pull/350))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8432)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...8.43.2)
