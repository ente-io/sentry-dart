...
- Bump Android SDK from v6.15.0 to v6.31.0 ([#98](https://github.com/ente-io/sentry-dart/pull/98))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6310)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...6.31.0)
