...
- Bump Android SDK from v6.15.0 to v8.27.0 ([#289](https://github.com/ente-io/sentry-dart/pull/289))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8270)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...8.27.0)
