...
- Bump Android SDK from v6.15.0 to v8.5.0 ([#219](https://github.com/ente-io/sentry-dart/pull/219))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#850)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...8.5.0)
