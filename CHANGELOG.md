...
- Bump Android SDK from v6.15.0 to v8.37.1 ([#326](https://github.com/ente-io/sentry-dart/pull/326))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8371)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...8.37.1)
