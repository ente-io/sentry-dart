...
- Bump Android SDK from v6.15.0 to v8.16.0 ([#252](https://github.com/ente-io/sentry-dart/pull/252))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8160)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...8.16.0)
