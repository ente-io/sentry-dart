...
- Bump Android SDK from v6.15.0 to v6.18.0 ([#48](https://github.com/ente-io/sentry-dart/pull/48))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6180)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...6.18.0)
