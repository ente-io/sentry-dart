...
- Bump Android SDK from v6.15.0 to v6.32.0 ([#99](https://github.com/ente-io/sentry-dart/pull/99))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6320)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...6.32.0)
