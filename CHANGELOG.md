...
- Bump Android SDK from v6.15.0 to v7.20.0 ([#201](https://github.com/ente-io/sentry-dart/pull/201))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#7200)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...7.20.0)
