...
- Bump Android SDK from v6.15.0 to v8.22.0 ([#272](https://github.com/ente-io/sentry-dart/pull/272))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8220)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...8.22.0)
