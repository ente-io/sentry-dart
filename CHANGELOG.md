...
- Bump Android SDK from v6.15.0 to v8.10.0 ([#227](https://github.com/ente-io/sentry-dart/pull/227))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8100)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...8.10.0)
