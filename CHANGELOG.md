...
- Bump Android SDK from v6.15.0 to v6.25.0 ([#70](https://github.com/ente-io/sentry-dart/pull/70))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6250)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...6.25.0)
