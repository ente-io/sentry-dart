...
- Bump Android SDK from v6.15.0 to v6.23.0 ([#67](https://github.com/ente-io/sentry-dart/pull/67))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6230)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...6.23.0)
