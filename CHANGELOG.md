...
- Bump Android SDK from v6.15.0 to v8.43.0 ([#346](https://github.com/ente-io/sentry-dart/pull/346))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8430)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.15.0...8.43.0)
