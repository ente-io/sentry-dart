...
- Bump Android SDK from v6.4.2 to v6.13.0 ([#29](https://github.com/ente-io/sentry-dart/pull/29))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6130)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.4.2...6.13.0)
